...
describe("companyApi.getSingleCompany", () => {
    ...
    test("2", async () => {
        expect.assertions(1)
        try {
            await companyApi.getSingleCompany("")
        } catch (e) {
            expect(e.message).toBe("Network Error")
        }
    })
...
describe("companyApi.updateCompany", () => {
    ...
    test("6", async () => {
        expect.assertions(1)
        try {
            await companyApi.updateCompany("03ea49f8-1d96-4cd0-b279-0684e3eec3a9", "Microsoft Corporation")
        } catch (e) {
            expect(e.message).toBe("Network Error")
        }
    })
    ...
    test("7", async () => {
        expect.assertions(1)
        try {
            await companyApi.updateCompany("a85a8e6b-348b-4011-a1ec-1e78e9620782", "Microsoft Corporation")
        } catch (e) {
            expect(e.message).toBe("Network Error")
        }
    })
